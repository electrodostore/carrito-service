package com.electrodostore.carrito_service.security.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                /**
                 * Configura el microservicio como OAuth2 Resourcre Serve
                 * para validar automáticamente tokens JWT.
                 */
                .oauth2ResourceServer(oauth2 ->
                        oauth2.jwt(
                                jwt -> jwt.jwtAuthenticationConverter(
                                        //Configura convertidor para extraer autoridades desde el JWT.
